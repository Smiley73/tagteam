---
name: fixer-xhigh
description: Applies a supplied set of findings inside an isolated worktree, and nothing else. Runs at xhigh effort — dispatch the variant the resolver names.
model: inherit
effort: xhigh
