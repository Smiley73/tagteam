---
name: plan-drafter-low
description: Writes and revises a plan index from a settled goal and repository evidence. Runs at low effort — dispatch the variant the resolver names.
model: inherit
effort: low
