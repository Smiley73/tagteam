---
name: spec-writer-xhigh
description: Writes one self-contained spec file for one deliverable of an approved plan. Runs at xhigh effort — dispatch the variant the resolver names.
model: inherit
effort: xhigh
