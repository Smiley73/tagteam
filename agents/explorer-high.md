---
name: explorer-high
description: Read-only orienteer. Reports how an area of the repository is built today, as a conclusion rather than a transcript. Runs at high effort — dispatch the variant the resolver names.
model: inherit
effort: high
