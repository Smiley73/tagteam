---
name: fixer-high
description: Applies a supplied set of findings inside an isolated worktree, and nothing else. Runs at high effort — dispatch the variant the resolver names.
model: inherit
effort: high
