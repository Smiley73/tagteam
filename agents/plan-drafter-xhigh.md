---
name: plan-drafter-xhigh
description: Writes and revises a plan index from a settled goal and repository evidence. Runs at xhigh effort — dispatch the variant the resolver names.
model: inherit
effort: xhigh
