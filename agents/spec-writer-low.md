---
name: spec-writer-low
description: Writes one self-contained spec file for one deliverable of an approved plan. Runs at low effort — dispatch the variant the resolver names.
model: inherit
effort: low
