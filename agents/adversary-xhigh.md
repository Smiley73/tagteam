---
name: adversary-xhigh
description: Read-only falsifier. Tries to show the work does not deliver what it claims, rather than to improve it. Runs at xhigh effort — dispatch the variant the resolver names.
model: inherit
effort: xhigh
