---
name: adversary-low
description: Read-only falsifier. Tries to show the work does not deliver what it claims, rather than to improve it. Runs at low effort — dispatch the variant the resolver names.
model: inherit
effort: low
