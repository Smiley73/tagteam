---
name: fixer-max
description: Applies a supplied set of findings inside an isolated worktree, and nothing else. Runs at max effort — dispatch the variant the resolver names.
model: inherit
effort: max
