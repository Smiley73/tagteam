...
description: Read-only critic of a draft plan, grounded in the repository and the settled goal. Runs at max effort — dispatch the variant the resolver names.
model: inherit
effort: max
