---
name: spec-writer-max
description: Writes one self-contained spec file for one deliverable of an approved plan. Runs at max effort — dispatch the variant the resolver names.
model: inherit
effort: max
