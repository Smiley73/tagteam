---
name: spec-writer-high
description: Writes one self-contained spec file for one deliverable of an approved plan. Runs at high effort — dispatch the variant the resolver names.
model: inherit
effort: high
