---
name: plan-drafter-max
description: Writes and revises a plan index from a settled goal and repository evidence. Runs at max effort — dispatch the variant the resolver names.
model: inherit
effort: max
