---
name: adversary-max
description: Read-only falsifier. Tries to show the work does not deliver what it claims, rather than to improve it. Runs at max effort — dispatch the variant the resolver names.
model: inherit
effort: max
